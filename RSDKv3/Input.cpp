...
#if RETRO_USING_SDL2
// These are declared in Input.hpp behind `#if RETRO_USING_SDL2` but were
// defined outside any guard, which only breaks on a build with no SDL at all
// (Dreamcast). Guard added to match the declaration.
